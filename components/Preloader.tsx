...
const Preloader = () => {
    ...
    return (
        <div className="fixed inset-0 z-[6] flex" ref={preloaderRef}>
            ...
            <p className="name-text flex overflow-hidden pb-[0.12em] text-[20vw] font-anton leading-none text-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:text-[200px]">
